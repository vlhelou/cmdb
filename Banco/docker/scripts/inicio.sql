...
INSERT INTO corp.configuracao (id,idpai,nome,ativo,tipovalor,valornumerico,valortexto,valordata,valorcomplexo,valorsensivel,ajuda,valorboleano) VALUES
	 ...
	 (6,4,'Servidor',true,'texto',NULL,'10.1.0.2',NULL,NULL,false,NULL,NULL),
	 (11,4,'Login DN',true,'texto',NULL,'CN=SerGsmHsm,OU=USUARIOS_SERVICOS,OU=HSM,DC=HSM,DC=COM,DC=BR',NULL,NULL,false,NULL,NULL),
	 (8,4,'Senha',true,'texto',NULL,'V95fAPy7YRFXUPy3lEigHA==',NULL,NULL,true,NULL,NULL);
INSERT INTO corp.configuracao (id,idpai,nome,ativo,tipovalor,valornumerico,valortexto,valordata,valorcomplexo,valorsensivel,ajuda,valorboleano) VALUES
	 (12,4,'Pesquisa nome usuário',true,'texto',NULL,'(&(objectCategory=person)(objectClass=user)(SamAccountName={0}))',NULL,NULL,false,NULL,NULL),
